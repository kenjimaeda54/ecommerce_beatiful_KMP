            ...
            VStack {
                VStack {
                    ZStack {
                        ...
                        TextField("", text: $searchProduct)
                            ...
                            .accessibilityLabel(acessibility_Label_Text_Field)
                    }
                    .padding(.vertical,10)
                    .background(
                ...
                VStack(alignment: .leading){
                    ...
                    ScrollViewReader { value in
                            ...
                            ScrollView(.horizontal)  {
                                LazyHStack(spacing: 15) {
                                    ForEach(Array(categoryMap.enumerated()),id: \.1.id) { (index,item) in
                                        ...
                                        .padding(.trailing,10)
                                        .accessibilityIdentifier(accesibility_Label_button_horizontal)
                                    }
                        ...
                        .accessibilityIdentifier(acessibility_Horizontal_Categories)
